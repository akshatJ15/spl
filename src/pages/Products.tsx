...
      description:
        "Discover the essence of engineering elegance with our artisanal plywood. Each sheet tells a story of strength, precision, and sophistication — elevating your interiors with warm, enduring character.",

      image:
        "https://images.pexels.com/photos/129731/pexels-photo-129731.jpeg?auto=compress&cs=tinysrgb&w=800", // Wood stack
...
      description:
        "Our resplendent laminate range is where form meets function. Rich textures and striking finishes breathe life into spaces, offering unmatched durability and design versatility.",

      image:
        "https://images.pexels.com/photos/1643389/pexels-photo-1643389.jpeg?auto=compress&cs=tinysrgb&w=800", // Texture
...
      description:
        "Elegant natural veneers that bring warmth, texture, and timeless beauty. Sourced from the finest timber, providing a unique grain pattern for every sheet.",

      image:
        "https://images.pexels.com/photos/3049121/pexels-photo-3049121.jpeg?auto=compress&cs=tinysrgb&w=800", // Veneer/Wood
...
      description:
        "Engineered for performance, Samrat HPL stands resilient in extreme conditions. From facades to furniture, experience architectural brilliance fused with uncompromised strength.",

      image:
        "https://images.pexels.com/photos/2079234/pexels-photo-2079234.jpeg?auto=compress&cs=tinysrgb&w=800", // Facade
...
      description:
        "Premium hardware engineered for smooth function and seamless design. From soft-close hinges to architectural handles, we ensure every detail matters.",

      image:
        "https://images.pexels.com/photos/1080721/pexels-photo-1080721.jpeg?auto=compress&cs=tinysrgb&w=800", // Metal/Hardware
...
      description:
        "Industrial-strength adhesives that hold it all together—flawlessly. Formulated for high bonding strength and water resistance.",

      image:
        "https://images.pexels.com/photos/6412952/pexels-photo-6412952.jpeg?auto=compress&cs=tinysrgb&w=800", // Glue/Craft
...
              >
                Explore our comprehensive range of premium plywood, laminates,
                and architectural finishes. Designed for durability and
...
                <Link
                  to="/catalogue"
                  className="group bg-amber-500 hover:bg-amber-400 text-stone-900 px-6 md:px-8 py-3 md:py-4 font-bold transition-all rounded-sm flex items-center justify-center sm:justify-start shadow-lg shadow-amber-900/50 text-sm md:text-base uppercase tracking-wider"
                >
...
      <h2 className="text-4xl md:text-5xl font-bold text-stone-900 mt-2 font-serif">
        Our Brand Partners
      </h2>
    </motion.div>
...
        viewport={{ once: true }}
        // Added 'relative overflow-hidden' here
        className="group relative overflow-hidden border border-stone-200 p-8 rounded-xl hover:shadow-2xl hover:border-amber-200 transition-all duration-300 bg-stone-50"
      >
        {/* --- Background Logo Layer --- */}
        {/* REPLACE src below with your actual Manilam logo path */}
        <img 
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTIAje8vuhUlrtHmhe07kBmhDNuFRBzeZErjQ&s" 
            alt="Manilam Background" 
            className="absolute inset-0 w-full h-full object-contain opacity-[0.1] grayscale pointer-events-none z-0"
        />
...
            We are proud partners with Manilam, bringing you world-class
            decorative laminates known for their vibrant designs and
            superior texture technology.
            </p>
...
      >
         {/* --- Background Logo Layer --- */}
         {/* REPLACE src below with your actual Jivanjor logo path */}
         <img 
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdskUOSw_4h83xtl1TA5ZLxHXVy-nCfjwELQ&s" 
            alt="Jivanjor Background" 
            className="absolute inset-0 w-full h-full object-contain opacity-[0.1] grayscale pointer-events-none z-0"
        />
...
            <p className="text-stone-600 mb-6 font-medium">
            Our alliance with Jivanjor ensures we provide the most reliable,
            industrial-strength adhesives for all your carpentry and joinery
            needs.
            </p>
...
            >
              From structural foundations to the final aesthetic touch, discover
...
              Our experts can guide you through the technical specifications of
              BWP Plywood, Laminate textures, and Adhesive applications.
            </p>
